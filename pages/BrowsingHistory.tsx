...
const BrowsingHistory: React.FC<BrowsingHistoryProps> = ({ onBack, onRecipeClick }) => {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50 animate-in slide-in-from-right duration-300">
            ...
            {loading ? (
                ...
                <RecipeList recipes={recipes} onRecipeClick={handleRecipeClick} emptyMessage="最近没有浏览过食谱" />
            )}
        </div>
    );
};
